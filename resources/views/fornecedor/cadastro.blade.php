  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div style="font-size:22px" class="sidebar-brand-text mx-3">Auto Elétrica</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/mostrar/compra">
          <i class="fas fa-fw fa-chart-area"></i>
          <span style="font-size:20px">COMPRAS</span></a>
      </li>

      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/mostrar/atendimento">
          <i class="fas fa-fw fa-chart-area"></i>
          <span style="font-size:20px">ATENDIMENTOS</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="/mostrar/carro">
          <i class="fas fa-fw fa-chart-area"></i>
          <span style="font-size:20px">CARROS</span></a>
      </li>

      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/mostrar/fornecedor">
          <i class="fas fa-fw fa-chart-area"></i>
          <span style="font-size:20px">FORNECEDORES</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="/mostrar/produto">
          <i class="fas fa-fw fa-chart-area"></i>
          <span style="font-size:20px">PRODUTOS</span></a>
      </li>
...
<div class="panel panel-primary">
      <div class="panel-heading"><h1>Cadastro de Fornecedores</h1></div> <br><br>
